...
public partial class BankPayment : System.Web.UI.Page
{
    ...
    protected void submit_Click(object sender, EventArgs e)
    {
        try
        {
            String paid1 = "", activity1 = "", economic1 = "", description1 = "", vat1 = "0", tax1 = "0", date1 = "",bank1="",cheque1="";
            bank1 = bank.Text;
            cheque1 = cheque.Text;
            paid1 = paid.Text;
            ...
            String query = "INSERT INTO bank(paid_to,bank_acc,cheque_num,date,tax,vat,total,initial,eco_code,description,activity) " +
                "VALUES('" + paid1 + "','" + bank1 +"','" +cheque1+"','"+ date1 + "','" + tax1 + "','" + vat1 + "','" + total1 + "','" + initial1 + "','" + economic1 + "','" + description1 + "','" + activity1 + "');";
        ...
        Response.BufferOutput = true;
        Response.Redirect("BankBill.aspx", false);
