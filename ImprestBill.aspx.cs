...
public partial class ImprestBill : System.Web.UI.Page
{
    String paid0 = "", date0 = "", voucher0 = "", project0 = "";
    String description0 = "", initial0 = "", tax0 = "", vat0 = "", total0 = "", word0 = "", eco0 = "";
    protected void Page_Load(object sender, EventArgs e)
    {
        String connStr = "datasource=127.0.0.1;port=3306;username=root;password=root;database=fablab_db;";
        MySqlConnection conn = new MySqlConnection(connStr);
        String query = "SELECT MAX(voucher) AS V FROM imprest";
        ...
        String query1 = "SELECT * FROM imprest WHERE voucher='" + voucher0 + "';";
        ...
        //string fname = "ImprestBill"+voucher0;
        ...
        HttpContext.Current.Response.AddHeader("Content-Disposition",
            String.Format("attachment;ImprestBill; size={0}", pdfBuffer.Length.ToString()));
